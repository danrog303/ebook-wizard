...
import {EbookProjectMetaEditFormComponent} from "@app/components/common/ebook-project-meta-edit-form/ebook-project-meta-edit-form.component";
...
export class EbookProjectMetaEditModal {
    constructor(@Inject(MAT_DIALOG_DATA) public ebookProject: EbookProject,
                @Inject(MatDialogRef) private readonly dialogRef: MatDialogRef<EbookProjectMetaEditModal>,
